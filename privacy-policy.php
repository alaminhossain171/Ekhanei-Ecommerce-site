...
<head>
    ...
    <title>Privacy policy - Ekhanei Sob</title>
...
<body>
  ...
  <section class="about-part">
    <div class="container">
      <h2 class="heading"> <span>Privacy Policy</span> </h2>
      <div class="support">
        <h4 class="title"> Data that we collect</h4>
      ...
      <div class="support">
        <h4 class="title">Third Parties and Links</h4>
        <p>We may pass your details to other companies in our group. We may also pass your details to our agents and subcontractors to help us with any of our uses of your data set out in our Privacy Policy. For example, we may use third parties to assist us with delivering products to you, to help us to collect payments from you, to analyze data and to provide us with marketing or customer service assistance.
