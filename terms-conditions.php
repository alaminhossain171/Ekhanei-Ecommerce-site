...
<head>
    ...
    <title>Terms and condition - Ekhanei Sob</title>
...
<section class="about-part">
    <div class="container">
      <h2 class="heading"> <span>
        Terms and Conditions</span> </h2>
      <div class="support">
        <h4 class="title"> OVERVIEW</h4>
        <p>This website is operated by Ekhanei-Sob.com. The terms “We”, “Us” and “Our” are used to refer to only Ekhanei-Sob.com. Ekhanei-Sob.com offers all information, tools and services which are used or concerns Ekhanei-Sob.com carrying out of business, and are publicly available at the website. The user shall be deemed to have accepted all the terms, conditions, policies and notices officially stated, as they continue to use the website and its services.
      ...
      <div class="support">
        <h4 class="title">GENERAL CONDITIONS</h4>
        <p>By agreeing to these Terms of Service, you represent that you are at the age of majority in your present State or Province of residence, or that you have given us your consent to allow any of your minor dependents to use this website where you are the age of majority in your State or Province of residence.
      ...
      <div class="support">
        <h4 class="title">THIRD PARTY LINKS</h4>
        <p>
